...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	if eth.protocolManager, err = NewProtocolManager(eth.chainConfig, config.SyncMode, config.NetworkId, maxPeers, eth.eventMux, eth.txPool, eth.engine, eth); err != nil {
		return nil, err
	}
